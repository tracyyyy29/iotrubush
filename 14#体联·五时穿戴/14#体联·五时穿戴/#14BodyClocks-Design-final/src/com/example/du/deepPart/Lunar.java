...
public class Lunar {
    ...
    public String getTermString() {
        ...
        else if(Lunar.getSolarTermDay(solarYear, solarMonth * 2) > solarDay){
        	termString = "上一个节气"+Lunar.solarTerm[((solarMonth-1)%12) * 2 ]+"已经过去"+getbeforesolarTerm(solarYear,date)+"天，"+"还有"+getaftersolarTerm(solarYear,date)+"天到达下一个节气"+Lunar.solarTerm[solarMonth * 2];
        }
        else if(Lunar.getSolarTermDay(solarYear, solarMonth * 2) < solarDay && Lunar.getSolarTermDay(solarYear, solarMonth * 2 + 1) > solarDay){
        	termString = "上一个节气"+Lunar.solarTerm[solarMonth * 2]+"已经过去"+getbeforesolarTerm(solarYear,date)+"天，"+"还有"+getaftersolarTerm(solarYear,date)+"天到达下一个节气"+Lunar.solarTerm[solarMonth * 2 + 1];
        }
        else if(Lunar.getSolarTermDay(solarYear, solarMonth * 2 + 1) < solarDay){
        	termString = "上一个节气"+Lunar.solarTerm[solarMonth * 2 + 1]+"已经过去"+getbeforesolarTerm(solarYear,date)+"天，"+"还有"+getaftersolarTerm(solarYear,date)+"天到达下一个节气"+Lunar.solarTerm[((solarMonth+1)%12) * 2 ];
        }
        return termString;
    }
...
//        }
//        else if(Lunar.getSolarTermDay(solarYear, solarMonth * 2) > solarDay){
//        	termString = "下一个节气是"+Lunar.solarTerm[solarMonth * 2];
//        }
//        else if(Lunar.getSolarTermDay(solarYear, solarMonth * 2) < solarDay && Lunar.getSolarTermDay(solarYear, solarMonth * 2 + 1) > solarDay){
//        	termString = "下一个节气是"+Lunar.solarTerm[solarMonth * 2 + 1];
//        }
//        else if(Lunar.getSolarTermDay(solarYear, solarMonth * 2 + 1) < solarDay){
//        	termString = "下一个节气是"+Lunar.solarTerm[((solarMonth+1)%12) * 2 ];
//        }
//        return termString;
//    }
