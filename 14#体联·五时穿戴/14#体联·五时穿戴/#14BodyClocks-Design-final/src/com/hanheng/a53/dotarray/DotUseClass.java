...
public class DotUseClass implements Runnable {
	private byte[] byteArr = new byte[32];
	private int showTime;

	private static DotUseClass instance = new DotUseClass();
	...
	public static DotUseClass getInstance() {
		if (instance == null) {
			instance = new DotUseClass();
		}
