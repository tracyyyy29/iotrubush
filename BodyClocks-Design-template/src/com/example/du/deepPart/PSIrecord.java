...
//		getIList();
	...
	private void getPSIData() {
		...
		com.example.du.deepPart.PSIInputUtil psiUtil = MainActivity.getpsiUtil();
...
public class PSIInputUtil extends SQLiteOpenHelper {
	...
	private void setpsiUtil() {
		// TODO Auto-generated method stub
		PSIInputUtil psiUtil = new PSIInputUtil(this, PSIInputUtil.TABLE_NAME + ".db", null,
				1);
